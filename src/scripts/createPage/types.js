...
module.exports = async ({ graphql, reporter, createPage, path, components, direction, category, context, season }) => {
  ...
  types.forEach(type => {
    ...
    createPage({
      path: `${ path.filterPage }/${ direction.node.path }/${ path.tours }/${ context.categoryPath || 'all' }/${ context.seasonPath || 'all' }/${ typePath }`,
